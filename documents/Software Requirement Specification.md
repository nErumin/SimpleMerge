...
![Use Case Diagram](https://github.com/nErumin/SimpleMerge/blob/983c7ff42826c2bbcba4fb00e9e9629e3e14b748/documents/diagram/Use%20digram.png?raw=true)
...
### 4. Constraints
- 모든 개발은 Java 언어로 이루어진다.
- GUI 개발을 위해서는 JavaFX를 사용한다.
- 일반적인 유닛 테스트는 JUnit 프레임워크를 통해 이루어진다.
- GUI 테스트를 위해서는 TestFX 프레임워크를 사용한다.
- 프로그램 실행을 위해서는 컴퓨터에 Java 환경이 준비되어 있어야 한다.
